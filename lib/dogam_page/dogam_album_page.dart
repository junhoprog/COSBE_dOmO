...
class _dogam_albumState extends State<dogam_album_page> {
  ...
  getData(int index) async {
    ...
    var result = await firestore.collection(documentId).doc(data[index][0].toString()).get();
              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                     ...
                     */
                        Text(data[widget.index][0].toString(),style: TextStyle(fontSize: 30,fontWeight: FontWeight.w700,color:Colors.white),),
                        Text(data[widget.index][2].toString(),style: TextStyle(fontSize:20,color:Colors.white),),
                      ],
                    ),
                  )
                ]
              ...
              child: ListView.builder(
                                  ...
                                  showDialog<void>(
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        title:Text(data[widget.index][0].toString()),
                ...
                /*  Text("${Imagemap_cheongju_title.keys.elementAt(index)}",style: TextStyle(fontSize: 20),),
                  Text("${Imagemap_cheongju_title.values.elementAt(index)}"),*/
                        Text(data[index][0].toString(),style: TextStyle(fontSize: 20),),
